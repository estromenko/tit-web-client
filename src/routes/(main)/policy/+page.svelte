<section class="xl:p-10">
  <div class="xl:border-2 rounded-md border-b shadow-lg pt-6 pb-6">
    <h2 class="ml-6 font-bold text-3xl">Политика в отношении обработки персональных данных</h2>
    <ol>
      <li class="mt-6 ml-6">
        <h6 class="text-xl font-bold">1. Общие положения</h6>
        <p class="mt-6">
          ...
          обеспечению безопасности персональных данных, предпринимаемые ИП Голышев Е.К. (далее —
          Оператор).
        </p>
        <ol>
          <li class="mt-6 ml-6">
          ...
          <li class="mt-6 ml-6">
            ...
            веб-сайта
            <a class="text-blue-600 hover:underline" href="https://tutorin.tech">
              https://tutorin.tech
            </a>.
          </li>
        </ol>
      ...
      <li class="mt-6 ml-6">
        <h6 class="text-xl font-bold">2. Основные понятия, используемые в Политике</h6>
        <ol>
          <li class="mt-6 ml-6">
          ...
          <li class="mt-6 ml-6">
            ...
            <a class="text-blue-600" href="https://tutorin.tech">https://tutorin.tech</a>.
          </li>
          <li class="mt-6 ml-6">
      ...
      <li class="mt-6 ml-6">
        <h6 class="text-xl font-bold">3. Основные права и обязанности Оператора</h6>
        <ol>
          <li class="mt-6 ml-6">
      ...
      <li class="mt-6 ml-6">
        <h6 class="text-xl font-bold">5. Принципы обработки персональных данных</h6>
        <ol>
          <li class="mt-6 ml-6">
      ...
      <li class="mt-6 ml-6">
        <h6 class="text-xl font-bold">6. Цели обработки персональных данных</h6>
        <table class="mt-6">
          <tr class="border-black border-2">
            <td class="p-2 border-black border-2 font-bold">Цель обработки</td>
            <td class="p-2 border-black border-2">
              Предоставление доступа Пользователю к сервисам, информации и/или материалам,
              содержащимся на веб-сайте
            </td>
          </tr>
          <tr>
            <td class="p-2 border-black border-2 font-bold">Персональные данные</td>
            <td class="p-2 border-black border-2">
              Электронный адрес Правовые основания договоры, заключаемые между оператором и
              субъектом персональных данных
            </td>
          </tr>
          <tr>
            <td class="p-2 border-black border-2 font-bold"> Виды обработки персональных данных</td>
            <td class="p-2 border-black border-2">
      ...
      <li class="mt-6 ml-6">
        <h6 class="text-xl font-bold">7. Условия обработки персональных данных</h6>
        <ol>
          <li class="mt-6 ml-6">
      ...
      <li class="mt-6 ml-6">
        ...
        <ol>
          ...
          <li class="mt-6 ml-6">
            ...
            электронной почты Оператора eugulixes@gmail.com с пометкой «Актуализация персональных
            данных».
          </li>
          <li class="mt-6 ml-6">
            ...
            электронный адрес Оператора eugulixes@gmail.com с пометкой «Отзыв согласия на обработку
            персональных данных».
          </li>
          <li class="mt-6 ml-6">
      ...
      <li class="mt-6 ml-6">
        <h6 class="text-xl font-bold">10. Трансграничная передача персональных данных</h6>
        <ol>
          <li class="mt-6 ml-6">
      ...
      <li class="mt-6 ml-6">
        <h6 class="text-xl font-bold">11. Конфиденциальность персональных данных</h6>
        <p class="mt-6">
      ...
      <li class="mt-6 ml-6">
        <h6 class="text-xl font-bold">12. Заключительные положения</h6>
        <ol>
          <li class="mt-6 ml-6">
          ...
          <li class="mt-6 ml-6">
            ...
            адресу
            <a class="text-blue-600 hover:underline" href="https://tutorin.tech/policy">
              https://tutorin.tech/policy
            </a>.
          </li>
        </ol>
      </li>
